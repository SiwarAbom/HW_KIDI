...
import com.example.demo.pckg1.Address;
...
public class Leader {
	...
	public Leader(String fullName, String email, String phoneNumber, Address address, Date dateOfBirth,
				  String profilePic, ArrayList<String> categoryIDs) {
		super();
	...
	public String toString() {
		return "Leader [ID=" + ID + ", fullName=" + fullName + ", email=" + email + ", phoneNumber=" + phoneNumber
				...
				+ ", categoryID=" + categoryIDs + ", coursesIDs=" + coursesIDs + ", activeStatus=" + activeStatus
